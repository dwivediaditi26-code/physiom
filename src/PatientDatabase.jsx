                      ...
                      return(
                        <div style={{display:"flex",flexDirection:"column",gap:6}}>
                          {omKeysAll.map(k=>{
                            ...
                            const max=OM_MAX[scaleId]||(typeof SCALES!=="undefined"&&SCALES[scaleId]&&SCALES[scaleId].maxScore)||100;
                            const pct=isNaN(curr)?0:Math.min(100,Math.max(0,(curr/max)*100));
                            const lowIsBetter=["odi","ndi","dash","quickdash","vas","nprs","tsk","fabq","fabqpa","pcs","womac","spadi","pdi","rmdq","tug","koosjr","hoosjr","qbpds","prtee","startback"].includes(scaleId);
