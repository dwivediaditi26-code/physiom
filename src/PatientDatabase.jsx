...
function BodyChartWidget({ data, set, compact = false }) {
  const PC = typeof getC === "function" ? getC() : { surface:"#ffffff", s2:"#EBEBED", border:"#E0E0E2", accent:"#7c3aed", text:"#0D0D0D", muted:"#6B6B6B", isDark:false };
  const { useState, useRef, useCallback } = React;
  const markers = Array.isArray(data.body_chart) ? data.body_chart : [];
  ...
  return (
    <div style={{ background:PC.surface, border:`1px solid ${PC.border}`, borderRadius:16, overflow:"hidden", marginBottom:16 }}>
      ...
      {markers.length > 0 && (
        <div style={{ borderTop:`1px solid ${PC.border}`, padding:"10px 14px", background:PC.s2||"#F9F9F9" }}>
      ...
      <div style={{background:"#F5F3FF",padding:"20px 20px 18px",flexShrink:0}}>
        <div style={{display:"flex",gap:16,alignItems:"flex-start"}}>
          ...
          <div style={{flex:1}}>
            ...
            {showDetails&&(
              <div style={{marginTop:8,display:"flex",flexDirection:"column",gap:4,padding:"10px 12px",background:"rgba(0,0,0,0.02)",borderRadius:10}}>
                  ...
                  <div style={{borderTop:`1px solid ${C.border}`}}>
                    ...
                    <div style={{padding:"10px 12px"}}>
                      ...
                      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:5}}>
                        <div style={{background:"#F9F9F9",borderRadius:9,padding:"7px 10px",textAlign:"center"}}>
              ...
              return (
                <div>
                  ...
                  {selRegions.length>0 ? selRegions.map((region,ri)=>{
                    ...
                    <div style={{background:"#F9F9F9",borderRadius:12,padding:"12px 14px",border:`1px dashed ${C.border}`,textAlign:"center",marginBottom:10}}>
