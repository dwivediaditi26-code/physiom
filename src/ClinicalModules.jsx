...
import { C, getC, RegionChips } from "./utils.jsx";
...
// Body-map palpation zones -- moved verbatim into their own data module so
// the Ortho wizard can share them without importing this whole file.
import { ANATOMICAL_HOTSPOTS } from "./palpationHotspots.js";
export { ANATOMICAL_HOTSPOTS };
import { SCALE_DATA_LABELS, ST_DATA_LABELS, ROM_DERIVED, MMT_DATA_LABELS, mmtFallbackLabel, resolveCyriaxKey, EXERCISE_DB, TEMPLATE_TX, PROGRAMME_TEMPLATES, ALL_EXERCISES } from "./sharedClinicalData.js";
...
function OutcomeMeasuresModule() {
  ...
  return (
    <div>
      {/* Toast */}
      {toast && (
        <div style={{ position:"fixed", bottom:"calc(80px + env(safe-area-inset-bottom))", left:"50%", transform:"translateX(-50%)", zIndex:999, background: toast.type==="warn"?"rgba(255,179,0,0.97)":"rgba(0,201,122,0.97)", color:"#000", fontWeight:700, fontSize:"0.78rem", padding:"9px 18px", borderRadius:10, boxShadow:"0 4px 20px rgba(0,0,0,0.3)", whiteSpace:"nowrap" }}>
          {toast.msg}
        </div>
      )}
...
// ANATOMICAL_HOTSPOTS now lives in palpationHotspots.js (imported at the
// top of this file and re-exported below) -- moved out verbatim so the
// Ortho wizard's region-wise Palpation screen can read the same data
// without importing this entire module.
...
export { GaitModule, OutcomeMeasuresModule, buildClinicalInterpretation, buildRealtimeSOAP,
  EXERCISE_DB, ALL_EXERCISES, PROGRAMME_TEMPLATES, TEMPLATE_TX, ExercisePrescriptionModule, PalpationModule,
  TreatmentTechniquesModule, TreatmentSessionLogModule, Sparkline, ObservationModule, detectModulesV2,
