...
const REGIONS = [
  { id:"anterior_head", view:"anterior", label:"Head",
    pts:[[16.21,4.53],[14.6,4.92],[13.42,3.87],[13.75,2.3],[14.6,0.85],[15.87,0.59],[17.65,0.72],[18.58,2.17],[18.84,3.74],[18.5,4.92]] },
  ...
  { id:"posterior_head", view:"posterior", label:"Head",
    pts:[[82.94,4.14],[82.43,5.45],[80.91,5.19],[80.99,3.22],[81.5,0.85],[83.03,0.85],[85.23,1.51],[85.31,3.35],[86.25,3.35],[86.25,5.32],[84.38,5.71]] },
  { id:"anterior_neck", view:"anterior", label:"Neck",
    pts:[[16.3,15.43],[14.26,12.02],[14.09,13.99],[13.16,14.9],[14.01,16.74],[15.96,17.66],[18.33,16.61],[19.43,15.96],[18.58,13.33],[18.08,11.75]] },
  ...
  { id:"posterior_neck", view:"posterior", label:"Neck",
    pts:[[83.62,12.67],[79.47,16.09],[80.99,14.38],[81.33,12.15],[81.33,8.34],[82.77,6.89],[84.47,8.21],[85.82,10.97],[86.42,14.64],[87.86,16.35]] },
  { id:"anterior_shoulder_rt", view:"anterior", label:"Shoulder Rt",
    pts:[[8.92,21.73],[7.4,26.59],[8.75,25.41],[10.45,23.83],[11.3,21.34],[11.81,19.76],[13.25,16.87],[11.72,16.35],[10.28,16.87],[9.01,18.19],[6.97,23.97]] },
  { id:"anterior_shoulder_lt", view:"anterior", label:"Shoulder Lt",
    pts:[[23.67,20.42],[23.42,18.45],[21.97,16.87],[20.7,16.22],[19.6,15.69],[19.69,17.93],[20.45,20.42],[21.64,22],[23.75,23.05],[25.11,21.86]] },
  ...
  { id:"posterior_shoulder_rt", view:"posterior", label:"Shoulder Rt",
    pts:[[90.06,20.42],[86.58,18.58],[86.75,20.68],[88.03,21.73],[90.23,23.44],[91.75,21.86],[91.42,18.58],[90.06,17.66],[88.7,16.61],[88.03,18.58],[87.52,22.13],[88.36,22.65],[89.55,23.31]] },
  { id:"posterior_shoulder_lt", view:"posterior", label:"Shoulder Lt",
    pts:[[76.75,19.11],[74.64,21.73],[74.72,23.44],[76.42,23.7],[78.36,21.86],[80.06,21.73],[80.14,19.24],[79.89,17.01],[78.96,15.82],[77.52,15.96],[76.16,16.87],[74.72,18.19],[74.3,20.16]] },
  { id:"anterior_chest", view:"anterior", label:"Chest",
    pts:[[16.47,19.76],[13.16,18.32],[12.31,18.71],[11.47,21.47],[11.72,22.78],[10.62,24.49],[11.38,25.8],[12.23,26.2],[12.99,28.69],[14.52,28.96],[15.45,28.96],[16.97,28.96],[19.09,28.82],[19.6,28.82],[21.04,27.25],[21.04,24.75],[21.72,24.75],[22.31,23.57],[21.21,21.73],[20.19,19.37],[19.26,17.79],[17.91,16.74],[15.87,17.27],[13.5,17.66]] },
  { id:"posterior_upper_back", view:"posterior", label:"Upper Back",
    pts:[[83.53,18.19],[81.5,20.16],[80.57,19.63],[80.31,16.87],[81.75,15.82],[83.7,15.69],[85.99,15.43],[88.19,16.22],[87.09,17.4],[86.08,18.45],[85.23,19.89],[84.21,20.42],[82.77,20.95]] },
  { id:"posterior_mid_back", view:"posterior", label:"Mid Back",
    pts:[[83.53,25.28],[81.25,20.68],[80.31,22.13],[79.38,23.7],[78.45,25.67],[78.36,28.3],[79.55,30.93],[82.18,32.76],[84.97,33.16],[86.58,35.13],[88.19,35.13],[88.79,33.03],[88.87,29.09],[89.47,26.85],[88.62,24.1],[87.35,22.26],[86.58,20.16],[83.79,21.34]] },
  ...
  { id:"posterior_low_back", view:"posterior", label:"Low Back",
    pts:[[83.7,38.94],[83.03,32.63],[81.92,33.95],[80.82,33.95],[79.3,34.34],[78.7,35.65],[78.7,38.8],[80.31,39.99],[81.58,40.77],[85.82,36.84],[85.91,34.87],[84.89,33.95],[83.36,33.81],[83.45,38.8],[84.72,39.86],[85.99,39.99],[88.87,40.25],[88.36,37.89],[88.19,35.52]] },
  { id:"anterior_arm_rt", view:"anterior", label:"Arm Rt",
    pts:[[8.92,29.48],[6.97,27.91],[6.81,30.01],[7.48,33.42],[9.26,34.47],[9.77,32.5],[10.79,28.04],[10.03,26.72],[8.42,26.72],[8.67,29.61],[10.53,27.77],[10.45,26.2],[10.03,24.62],[8.58,23.83],[7.74,23.97],[7.4,25.8]] },
  ...
  { id:"posterior_arm_rt", view:"posterior", label:"Arm Rt",
    pts:[[90.99,28.96],[92.6,25.94],[92.6,23.7],[90.82,23.44],[89.47,23.83],[89.13,26.33],[89.3,30.14],[90.23,32.9],[91.33,34.34],[92.52,34.21],[92.94,31.32]] },
  { id:"posterior_arm_lt", view:"posterior", label:"Arm Lt",
    pts:[[75.74,29.61],[77.6,27.51],[77.86,26.2],[77.69,24.75],[76.5,23.31],[75.31,23.44],[74.47,24.49],[74.38,27.38],[75.65,30.53],[77.26,34.21],[74.89,34.73],[73.96,33.55],[73.36,31.71]] },
  { id:"posterior_hip_rt", view:"posterior", label:"Hip & Gluteal Rt",
    pts:[[87.86,49.18],[89.3,46.55],[89.21,43.53],[88.45,41.69],[87.43,40.25],[85.91,42.22],[85.48,43.66],[84.72,44.45],[84.72,47.47],[84.21,49.31],[84.64,51.67],[86.08,52.86],[87.69,52.33],[88.96,51.81],[88.53,49.44],[89.13,46.68]] },
  { id:"posterior_hip_lt", view:"posterior", label:"Hip & Gluteal Lt",
    pts:[[80.31,47.47],[83.36,49.57],[82.18,47.08],[81.84,44.32],[81.16,41.04],[78.79,40.38],[77.86,42.09],[77.86,45.9],[77.09,48.65],[77.52,50.62],[78.62,51.54],[80.74,52.2],[82.26,52.46],[83.03,51.54],[83.19,49.97]] },
  ...
  { id:"anterior_groin", view:"anterior", label:"Groin",
    pts:[[16.47,49.7],[15.87,55.22],[14.43,55.09],[14.01,53.25],[13.84,48],[15.53,47.08],[17.57,46.68],[18.84,46.95],[19.09,48.26],[19.18,50.1],[18.75,52.2],[18.33,53.91],[17.48,54.96],[16.64,55.48]] },
  { id:"posterior_sacrum", view:"posterior", label:"Sacrum / Tail Bone",
    pts:[[83.53,45.11],[83.28,43.01],[81.84,42.48],[82.94,49.31],[84.21,48.79],[85.65,42.74]] },
  { id:"posterior_si_joint", view:"posterior", label:"SI Joint",
    pts:[[83.7,42.48],[80.82,42.35],[81.84,44.19],[82.35,45.11],[84.04,45.5],[85.57,43.53],[86.58,41.83],[85.57,40.91]] },
  { id:"anterior_hip_rt", view:"anterior", label:"Hip Joint Rt",
    pts:[[12.99,50.89],[15.11,50.1],[13.58,47.87],[12.57,45.9],[11.13,46.03],[10.28,48.26],[10.28,51.41],[12.4,53.12],[13.84,53.64],[15.19,52.46],[15.28,51.15]] },
  { id:"anterior_hip_lt", view:"anterior", label:"Hip Joint Lt",
    pts:[[20.53,49.18],[21.89,47.34],[21.72,44.58],[20.28,44.58],[19.18,47.08],[17.57,49.05],[17.65,51.15],[19.86,52.86],[22.14,51.28],[22.4,47.6]] },
  { id:"anterior_thigh_rt", view:"anterior", label:"Thigh Rt",
    pts:[[12.65,57.32],[15.03,56.53],[14.09,53.91],[12.82,53.12],[10.96,52.59],[10.62,56.4],[10.53,59.16],[10.53,62.44],[11.81,63.49],[12.74,64.81],[14.86,64.41],[15.03,62.18],[15.03,60.34],[15.19,58.24]] },
  { id:"anterior_thigh_lt", view:"anterior", label:"Thigh Lt",
    pts:[[19.69,59.29],[22.74,58.11],[22.74,55.35],[21.97,53.64],[20.96,51.81],[19.69,52.07],[19.01,52.2],[18.08,53.91],[16.81,56.8],[17.57,59.95],[17.57,62.57],[19.01,62.84],[21.3,62.84],[22.57,60.08]] },
  { id:"anterior_knee_rt", view:"anterior", label:"Knee Rt",
    pts:[[13.84,68.09],[11.3,69.67],[11.47,72.42],[12.91,75.44],[14.26,75.05],[14.94,73.21],[15.11,69.8],[15.19,64.81],[12.99,64.28],[12.14,64.15],[11.21,64.67],[11.47,67.43]] },
  { id:"anterior_knee_lt", view:"anterior", label:"Knee Lt",
    pts:[[19.43,68.48],[17.48,69.14],[17.4,67.3],[17.31,64.54],[18.67,63.23],[20.28,63.89],[21.13,64.54],[21.38,67.83],[21.13,69.93],[20.62,73.47],[18.75,72.55],[17.82,72.03],[17.48,69.4]] },
  ...
  { id:"posterior_knee_rt", view:"posterior", label:"Knee Rt",
    pts:[[86.92,68.48],[88.87,67.83],[88.87,66.25],[88.11,64.81],[87.09,63.89],[85.31,64.28],[84.55,65.59],[84.47,68.35],[85.31,71.11],[86.08,71.63],[87.6,72.16],[88.28,70.72],[88.62,69.67]] },
  { id:"posterior_knee_lt", view:"posterior", label:"Knee Lt",
    pts:[[80.06,68.09],[82.52,67.83],[82.18,66.25],[80.99,64.94],[79.04,64.15],[77.94,65.59],[78.19,70.19],[78.7,72.16],[80.65,71.63],[81.5,70.98],[82.35,68.75]] },
];
