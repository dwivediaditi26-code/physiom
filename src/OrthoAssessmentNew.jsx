...
/* ============================================================
   ...
   ============================================================ */
export default function OrthoAssessmentNew({ onNav, navContext, onSave, activePatientId, requireAuth, entryMode, patientData, resume } = {}) {
  return <OrthoAssessment onExit={() => onNav?.("clinical")} onNav={onNav} navContext={navContext} onSave={onSave} activePatientId={activePatientId} requireAuth={requireAuth} entryMode={entryMode} patientData={patientData} resume={resume} />;
}
