...
export default function AssessmentReportView({ patient, onNav, onBack }) {
  ...
  return (
    <div style={{ maxWidth: 720, margin: "0 auto", padding: "16px 14px 100px" }}>
      ...
      {(hasCardio || hasNeuro) && (
        <div style={{ position: "fixed", left: "calc(50% + var(--pm-side-w, 0px) / 2)", transform: "translateX(-50%)", bottom: "var(--pm-bnav-h, calc(60px + env(safe-area-inset-bottom)))", width: "100%", maxWidth: 720, padding: "0 14px", display: "flex", gap: 8, zIndex: 25 }}>
          {hasCardio && (
