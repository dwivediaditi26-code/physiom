...
export const OBSERVATION_INFO = {
  ...
  attitude: [
    "HOW TO OBSERVE",
    "1. Note the resting position the limb is held in, unprompted, in each position.",
    "2. A limb guarded in a fixed position (e.g. flexed, externally rotated) can itself point to the pathology.",
    "",
    "WHAT TO LOOK FOR",
    "• Position held at rest — supine, sitting and standing",
    "• Whether the position changes between positions, or is fixed throughout",
  ].join("\n"),
  local: [
    "HOW TO OBSERVE",
