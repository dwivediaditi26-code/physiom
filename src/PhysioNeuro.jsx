...
const ROM_DATA={
  "Cervical":[
    {id:"rom_cflex",mv:"Flexion",bilateral:false,normal:45,unit:"deg",plane:"Sagittal",axis:"Frontal (coronal)",
     ...
     pediatric:"Neonatal: limited = torticollis, Klippel-Feil. Children: normal=80deg",
     geriatric:"Degenerative changes reduce all planes by 25-30% by age 70"},
    {id:"rom_cext",mv:"Extension",bilateral:false,normal:45,unit:"deg",plane:"Sagittal",axis:"Frontal",
    ...
    {id:"rom_clatl",mv:"Lat Flex L",bilateral:false,normal:45,unit:"deg",plane:"Frontal",axis:"AP (anterior-posterior)",
    ...
    {id:"rom_clatr",mv:"Lat Flex R",bilateral:false,normal:45,unit:"deg",plane:"Frontal",axis:"AP",
     ...
     capsular:"Compare L vs R: asymmetry >10deg clinically significant",
    ...
    {id:"rom_crotl",mv:"Rotation L",bilateral:false,normal:60,unit:"deg",plane:"Transverse",axis:"Vertical (longitudinal)",
     ...
     redflag:"<30deg rotation = atlantoaxial instability or end-stage OA. VBI symptoms: dizziness, nystagmus, diplopia"},
    {id:"rom_crotr",mv:"Rotation R",bilateral:false,normal:60,unit:"deg",plane:"Transverse",axis:"Vertical",
     ...
     redflag:"RA patient: odontoid fracture risk - <30deg rotation -> X-ray"},
  ],
  "Thoracic":[
    {id:"rom_thflex",mv:"Flexion",bilateral:false,normal:50,unit:"deg",plane:"Sagittal",axis:"Frontal",
    ...
    {id:"rom_thext",mv:"Extension",bilateral:false,normal:25,unit:"deg",plane:"Sagittal",axis:"Frontal",
    ...
    {id:"rom_throtl",mv:"Rotation L",bilateral:false,normal:35,unit:"deg",plane:"Transverse",axis:"Vertical",
    ...
    {id:"rom_throtr",mv:"Rotation R",bilateral:false,normal:35,unit:"deg",plane:"Transverse",axis:"Vertical",
  ...
  "Lumbar":[
    {id:"rom_lflex",mv:"Flexion",bilateral:false,normal:60,unit:"deg",plane:"Sagittal",axis:"Frontal",
    ...
    {id:"rom_lext",mv:"Extension",bilateral:false,normal:25,unit:"deg",plane:"Sagittal",axis:"Frontal",
    ...
    {id:"rom_llfl",mv:"Lat Flex L",bilateral:false,normal:25,unit:"deg",plane:"Frontal",axis:"AP",
    ...
    {id:"rom_llfr",mv:"Lat Flex R",bilateral:false,normal:25,unit:"deg",plane:"Frontal",axis:"AP",
     ...
     adl:"Same",pathology:"Compare with L - asymmetry >10deg significant",
     redflag:"Painful list = disc pathology - assess dermatomes"},
    {id:"rom_lrotl",mv:"Rotation L",bilateral:false,normal:5,unit:"deg",plane:"Transverse",axis:"Vertical",
     ...
     capsular:"NOTE: lumbar rotation is very limited (5deg) - restriction most significant in acute disc",
    ...
    {id:"rom_lrotr",mv:"Rotation R",bilateral:false,normal:5,unit:"deg",plane:"Transverse",axis:"Vertical",
  ...
  "Shoulder":[
    {id:"rom_sflex",mv:"Flexion",bilateral:true,normal:180,unit:"deg",plane:"Sagittal",axis:"Frontal",
     start:"Supine or seated; scapula stabilised after 60deg",gonio:"Axis: lateral shoulder (GH joint); Fixed: mid-axillary line; Moving: lateral humerus to lateral epicondyle",
     muscles:"Anterior deltoid, coracobrachialis (0-90deg); upper trap + serratus anterior (scapular upward rotation 60-180deg)",
     ...
     capsular:"GH capsular pattern: ER>Abd>IR (Cyriax); impingement pattern: painful arc 60-120deg",
     adl:"Reaching overhead (shelf, hair wash), throwing, swimming",
     pathology:"Arc 60-120deg: impingement or partial RC. Arc 120-180deg on ascent: AC joint. Full loss: frozen shoulder",
     redflag:"Sudden painless loss after trauma = complete RC tear. Fever + hot joint = septic arthritis"},
    {id:"rom_sext",mv:"Extension",bilateral:true,normal:60,unit:"deg",plane:"Sagittal",axis:"Frontal",
    ...
    {id:"rom_sabd",mv:"Abduction",bilateral:true,normal:180,unit:"deg",plane:"Frontal",axis:"AP",
     start:"Seated, elbow extended, thumb up (scapular plane preferred = 30deg forward)",gonio:"Axis: posterior GH joint; Fixed: parallel to spine; Moving: posterior humerus",
     muscles:"Supraspinatus (0-15deg), deltoid (15-90deg), serratus + trap (60-180deg scapular rotation)",
     ...
     pathology:"Arc 60-120deg: impingement or partial RC; Full loss: frozen shoulder, GH OA, complete RC tear",
     redflag:"Acute painful arc + weakness + trauma = complete RC tear. Document scapulohumeral rhythm deviation"},
    {id:"rom_sadd",mv:"Adduction",bilateral:true,normal:30,unit:"deg",plane:"Frontal",axis:"AP",
    ...
    {id:"rom_ser",mv:"ER",bilateral:true,normal:90,unit:"deg",plane:"Transverse",axis:"Vertical",
     start:"Supine, shoulder 0deg abduction, elbow 90deg; ALSO test at 90deg abduction",gonio:"Axis: olecranon; Fixed: vertical/perpendicular to table; Moving: ulna/forearm",
     ...
     pathology:"ER loss primary sign of GH capsular restriction. ER loss at 90deg = posterior capsule tightness -> impingement",
     redflag:"ER lag sign (passive > active by >5deg) = infraspinatus tear. Profound ER weakness = axillary nerve injury"},
    {id:"rom_sir",mv:"IR",bilateral:true,normal:70,unit:"deg",plane:"Transverse",axis:"Vertical",
     start:"Supine, shoulder 0deg abduction, elbow 90deg; assess thumb-to-back (functional IR) = N: T8-T10 level",gonio:"Axis: olecranon; Fixed: vertical; Moving: ulna",
     ...
     pathology:"GIRD: IR loss >15deg vs opposite in overhead athletes -> impingement risk. Posterior labral tear",
     redflag:"Internal rotation lag sign = subscapularis tear. Belly press weakness = subscapularis rupture"},
    {id:"rom_shabd",mv:"Horiz Abduction",bilateral:true,normal:45,unit:"deg",plane:"Transverse",axis:"Vertical",
     start:"Supine or seated, shoulder 90deg abduction -> assess horizontal abd",gonio:"Axis: AC joint; Fixed: acromion line; Moving: humerus",
    ...
    {id:"rom_shadd",mv:"Horiz Adduction",bilateral:true,normal:135,unit:"deg",plane:"Transverse",axis:"Vertical",
     start:"Shoulder 90deg flex -> add horizontally across body",gonio:"Axis: posterior GH; Fixed: shoulder line; Moving: humerus",
  ...
  "Elbow":[
    {id:"rom_eflex",mv:"Flexion",bilateral:true,normal:145,unit:"deg",plane:"Sagittal",axis:"Frontal",
    ...
    {id:"rom_eext",mv:"Extension",bilateral:true,normal:0,unit:"deg",plane:"Sagittal",axis:"Frontal",
    ...
    {id:"rom_esup",mv:"Supination",bilateral:true,normal:90,unit:"deg",plane:"Transverse",axis:"Longitudinal",
     start:"Elbow 90deg flexion, arm at side (eliminates shoulder rotation compensation)",gonio:"Axis: third finger; Fixed: parallel to humerus; Moving: dorsal forearm/pencil held in hand",
    ...
    {id:"rom_epro",mv:"Pronation",bilateral:true,normal:90,unit:"deg",plane:"Transverse",axis:"Longitudinal",
     start:"Elbow 90deg flexion, arm at side",gonio:"Same as supination",
  ...
  "Wrist":[
    {id:"rom_wflex",mv:"Wrist Flexion",bilateral:true,normal:80,unit:"deg",plane:"Sagittal",axis:"Frontal",
    ...
    {id:"rom_wext",mv:"Wrist Extension",bilateral:true,normal:70,unit:"deg",plane:"Sagittal",axis:"Frontal",
     ...
     redflag:"<30deg extension after Colles fracture = malunion - DRUJ check"},
    {id:"rom_wrad",mv:"Radial Deviation",bilateral:true,normal:20,unit:"deg",plane:"Frontal",axis:"AP",
    ...
    {id:"rom_wuln",mv:"Ulnar Deviation",bilateral:true,normal:30,unit:"deg",plane:"Frontal",axis:"AP",
  ...
  "Hand & Fingers":[
    {id:"rom_mcp",mv:"MCP Flexion",bilateral:true,normal:90,unit:"deg",plane:"Sagittal",axis:"Frontal",
    ...
    {id:"rom_pip",mv:"PIP Flexion",bilateral:true,normal:100,unit:"deg",plane:"Sagittal",axis:"Frontal",
    ...
    {id:"rom_dip",mv:"DIP Flexion",bilateral:true,normal:90,unit:"deg",plane:"Sagittal",axis:"Frontal",
    ...
    {id:"rom_thabdm",mv:"Thumb Abd/Ext",bilateral:true,normal:70,unit:"deg",plane:"Frontal",axis:"AP",
  ...
  "Hip":[
    {id:"rom_hflex",mv:"Flexion",bilateral:true,normal:120,unit:"deg",plane:"Sagittal",axis:"Frontal",
    ...
    {id:"rom_hext",mv:"Extension",bilateral:true,normal:20,unit:"deg",plane:"Sagittal",axis:"Frontal",
     start:"Prone, stabilise pelvis; knee extended (test hip capsule) + knee flexed 90deg (test iliopsoas)",gonio:"Axis: greater trochanter; Fixed: mid-axillary line; Moving: lateral femur",
    ...
    {id:"rom_habd",mv:"Abduction",bilateral:true,normal:45,unit:"deg",plane:"Frontal",axis:"AP",
     ...
     muscles:"Gluteus medius/minimus, TFL, piriformis (at 0deg flex)",
    ...
    {id:"rom_hadd",mv:"Adduction",bilateral:true,normal:30,unit:"deg",plane:"Frontal",axis:"AP",
    ...
    {id:"rom_her",mv:"ER",bilateral:true,normal:45,unit:"deg",plane:"Transverse",axis:"Vertical",
     start:"Supine, hip + knee 90deg (seated) OR prone, knee 90deg (pelvis stabilised)",gonio:"Axis: knee (midpoint); Fixed: vertical; Moving: distal fibula/tibia (pendulum method)",
    ...
    {id:"rom_hir",mv:"IR",bilateral:true,normal:45,unit:"deg",plane:"Transverse",axis:"Vertical",
     start:"Prone knee 90deg (most reliable); or supine hip 90deg",gonio:"Same pendulum method as ER",
  ...
  "Knee":[
    {id:"rom_kflex",mv:"Flexion",bilateral:true,normal:140,unit:"deg",plane:"Sagittal",axis:"Frontal",
     ...
     adl:"Stair climbing (N=85deg), sitting (N=90deg), squatting (N=130deg), kneeling (N=140deg)",
     pathology:"Limited flex: knee OA, effusion (30deg is maximum comfortable flexion in effusion), patellofemoral OA, quadriceps contracture",
     redflag:"Springy block = meniscal tear (bucket handle). Locked knee = urgent. Haemarthrosis post-trauma = ACL tear"},
    {id:"rom_kext",mv:"Extension",bilateral:true,normal:0,unit:"deg",plane:"Sagittal",axis:"Frontal",
     ...
     adl:"Walking (requires 0deg), stair descent, standing",
     ...
     redflag:"Extension lag >10deg = quadriceps mechanism injury (patella or patellar tendon). PCL injury = posterior sag"},
  ],
  "Ankle":[
    {id:"rom_adf",mv:"Dorsiflexion",bilateral:true,normal:20,unit:"deg",plane:"Sagittal",axis:"Frontal",
     ...
     adl:"Stair climbing (N=15-20deg), squatting, kneeling, gait push-off",
     pathology:"Limited DF: Achilles/soleus tightness (equinus), anterior bony impingement, os trigonum, posterior capsule adhesions",
     redflag:"<10deg DF = kinetic chain effects: knee valgus, foot pronation, pelvic anterior tilt in squat. Heel cord: Silfverskiöld test"},
    {id:"rom_apf",mv:"Plantarflexion",bilateral:true,normal:50,unit:"deg",plane:"Sagittal",axis:"Frontal",
    ...
    {id:"rom_ainv",mv:"Inversion",bilateral:true,normal:35,unit:"deg",plane:"Frontal",axis:"AP",
     ...
     redflag:">35deg inversion + pain + swelling post-sprain = grade III ATFL tear - anterior draw test. Ottawa rules: X-ray"},
    {id:"rom_aev",mv:"Eversion",bilateral:true,normal:15,unit:"deg",plane:"Frontal",axis:"AP",
  ...
  "Foot":[
    {id:"rom_1mtpf",mv:"1st MTP Extension",bilateral:true,normal:70,unit:"deg",plane:"Sagittal",axis:"Frontal",
     ...
     adl:"Walking push-off (requires 65-70deg MTP extension), running, going up stairs",
    ...
    {id:"rom_1mtpp",mv:"1st MTP Flexion",bilateral:true,normal:45,unit:"deg",plane:"Sagittal",axis:"Frontal",
    ...
    {id:"rom_mtpf2",mv:"2nd-5th MTP Extension",bilateral:true,normal:40,unit:"deg",plane:"Sagittal",axis:"Frontal",
...
const ROM_REDFLAGS=[
  {test:(mv,val)=>mv.toLowerCase().includes("cervical")&&parseFloat(val)<20,msg:"Cervical ROM <20deg - fracture/instability protocol. Do not passively test.",color:"#ff4d6d"},
  {test:(mv,val)=>mv.toLowerCase().includes("ankle dorsiflexion")&&parseFloat(val)<10,msg:"Ankle DF <10deg - significant equinus. Kinetic chain assessment required.",color:"#ff8c42"},
  {test:(mv,val)=>mv.toLowerCase().includes("hip ir")&&parseFloat(val)<20,msg:"Hip IR <20deg - possible early hip OA or FAI. Labral tear assessment indicated.",color:"#ff8c42"},
  {test:(mv,val)=>mv.toLowerCase().includes("knee flex")&&parseFloat(val)<90,msg:"Knee flexion <90deg - functional limitation for ADLs. Effusion assessment needed.",color:"#ff8c42"},
];
    ...
    <div>
      ...
      <div style={{display:"flex",gap:6,marginBottom:10,flexWrap:"wrap"}}>
        ...
        <div style={{marginLeft:"auto"}}>
          {btn(showSoap?"^ Hide SOAP":"v SOAP Note",showSoap,()=>setShowSoap(p=>!p),C.a3)}
        </div>
      </div>
              ...
              <div onClick={()=>setSelected(isOpen?null:m.id)} style={{padding:"10px 12px",cursor:"pointer"}}>
                <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",gap:8}}>
                  ...
                  <div style={{display:"flex",gap:8,alignItems:"flex-end"}}>
                    ...
                    <span style={{color:C.muted,fontSize:"0.7rem"}}>{isOpen?"^":"v"}</span>
                  </div>
                </div>
...
const MMT_DATA={
  ...
  "Shoulder & Scapula":[
    {id:"mmt_deltA",muscle:"Deltoid - Anterior",action:"Shoulder flexion 0-90deg",nerve:"Axillary nerve",root:"C5-C6",origin:"Anterior lateral clavicle",insertion:"Deltoid tuberosity",
     patient:"Seated, arm at side",therapist:"Proximal forearm; stabilise shoulder",resistance:"Downward into extension at ~80deg flex",gravElim:"Sidelying, support arm horizontal",palpation:"Anterior shoulder - bulk anterior to acromion",
    ...
    {id:"mmt_deltM",muscle:"Deltoid - Middle",action:"Shoulder abduction 0-90deg",nerve:"Axillary nerve",root:"C5-C6",origin:"Acromion",insertion:"Deltoid tuberosity",
     patient:"Seated",therapist:"Proximal forearm; scapula stabilised",resistance:"Downward into adduction at 90deg abd",gravElim:"Supine, arm horizontal",palpation:"Lateral shoulder - most prominent deltoid mass",
    ...
    {id:"mmt_supra",muscle:"Supraspinatus",action:"Shoulder abduction initiation (0-15deg) + GH compression",nerve:"Suprascapular nerve",root:"C5-C6",origin:"Supraspinous fossa",insertion:"Greater tuberosity (superior facet)",
     patient:"Seated, scapular plane (30deg forward of frontal)",therapist:"Proximal forearm",resistance:"Downward at 90deg in scapular plane",gravElim:"Supine",palpation:"Superior fossa above scapular spine - assess for atrophy",
    ...
    {id:"mmt_infra",muscle:"Infraspinatus",action:"Shoulder ER",nerve:"Suprascapular nerve",root:"C5-C6",origin:"Infraspinous fossa",insertion:"Greater tuberosity (middle facet)",
     patient:"Prone, arm over edge, elbow 90deg",therapist:"Distal forearm; stabilise elbow",resistance:"Into IR (downward) at neutral rotation",gravElim:"Supine, elbow at side",palpation:"Infraspinous fossa below scapular spine - assess for atrophy",
    ...
    {id:"mmt_subscap",muscle:"Subscapularis",action:"Shoulder IR",nerve:"Upper + lower subscapular nerves",root:"C5-C6",origin:"Subscapular fossa",insertion:"Lesser tuberosity",
     patient:"Prone, arm over edge, elbow 90deg",therapist:"Distal forearm",resistance:"Into ER (upward)",gravElim:"Supine",palpation:"Axilla - difficult; use lift-off + belly press tests",
    ...
    {id:"mmt_tmin",muscle:"Teres Minor",action:"Shoulder ER + GH compression",nerve:"Axillary nerve",root:"C5-C6",origin:"Lateral border scapula (upper 2/3)",insertion:"Greater tuberosity (inferior facet)",
     patient:"Prone, arm over edge, elbow 90deg",therapist:"Distal forearm",resistance:"Into IR",gravElim:"Supine",palpation:"Posterior axillary fold lateral to infraspinatus - below scapular spine",
     compensation:"Same as infraspinatus",substitution:"Infraspinatus",
     functional:"Hornblower's sign specific for teres minor. Isolated ER at 90deg abd",chain:"Teres minor tear -> ER lag at 90deg abduction - Hornblower positive"},
    ...
    {id:"mmt_lat",muscle:"Latissimus Dorsi",action:"Shoulder IR + extension + adduction; depression of shoulder girdle",nerve:"Thoracodorsal nerve",root:"C6-C8",origin:"T7-L5 SPs + iliac crest + inferior angle scapula",insertion:"Floor bicipital groove",
     patient:"Prone, arm abducted 120deg, IR (thumb down)",therapist:"Distal humerus",resistance:"Upward and outward (into abduction+ER)",gravElim:"Sidelying",palpation:"Posterior axillary fold and lateral thorax - large fan",
    ...
    {id:"mmt_pec_maj_c",muscle:"Pectoralis Major - Clavicular",action:"Shoulder flexion + horizontal adduction",nerve:"Lateral pectoral nerve",root:"C5-C6",origin:"Medial clavicle",insertion:"Lateral lip bicipital groove",
     patient:"Supine, arm 90deg flex",therapist:"Distal humerus",resistance:"Into extension + abduction",gravElim:"Seated, arm supported",palpation:"Superior pec - anterior axillary fold, near clavicle",
    ...
    {id:"mmt_pec_maj_s",muscle:"Pectoralis Major - Sternal",action:"Shoulder adduction + IR + extension from 90deg flex",nerve:"Medial + lateral pectoral nerves",root:"C6-T1",origin:"Sternum + ribs 2-6",insertion:"Lateral lip bicipital groove",
     patient:"Supine, arm 60deg abduction",therapist:"Distal humerus",resistance:"Into abduction",gravElim:"Seated, arm supported",palpation:"Anterior chest - sternal portion below clavicular head",
    ...
    {id:"mmt_trap_m",muscle:"Middle Trapezius",action:"Scapular retraction",nerve:"CN XI + C3-C4",root:"C3-C4",origin:"C7-T3 spinous processes",insertion:"Acromion + scapular spine (medial)",
     patient:"Prone, arm 90deg abduction (T position)",therapist:"Distal humerus",resistance:"Into protraction (downward and forward)",gravElim:"Seated, arm supported",palpation:"Between scapulae at T1-T3 level",
    ...
    {id:"mmt_trap_l",muscle:"Lower Trapezius",action:"Scapular depression + upward rotation + retraction",nerve:"CN XI + C3-C4",root:"C3-C4",origin:"T4-T12 spinous processes",insertion:"Scapular spine (medial end)",
     patient:"Prone, arm 130-160deg (Y position)",therapist:"Distal humerus",resistance:"Downward and lateral (into elevation + protraction)",gravElim:"Seated, arm at 130deg",palpation:"Inferior to scapular spine converging toward T5-T8 midline",
    ...
    {id:"mmt_corbrach",muscle:"Coracobrachialis",action:"Shoulder flexion + adduction",nerve:"Musculocutaneous nerve",root:"C5-C7",origin:"Coracoid process",insertion:"Medial humerus (mid-shaft)",
     patient:"Seated, arm 45deg flexion + slight adduction",therapist:"Distal humerus",resistance:"Into extension + abduction",gravElim:"Sidelying",palpation:"Medial arm proximal - deep to biceps in axilla region",
  ...
  "Elbow & Forearm":[
    {id:"mmt_bicep",muscle:"Biceps Brachii",action:"Elbow flexion + forearm supination",nerve:"Musculocutaneous nerve",root:"C5-C6",origin:"Coracoid (short) + supraglenoid tubercle (long)",insertion:"Radial tuberosity + bicipital aponeurosis",
     patient:"Seated, elbow 90deg, forearm supinated",therapist:"Distal forearm",resistance:"Into extension",gravElim:"Supine, arm at side",palpation:"Anterior arm belly - most palpable with supinated elbow flex",
    ...
    {id:"mmt_brach",muscle:"Brachialis",action:"Elbow flexion (all positions)",nerve:"Musculocutaneous nerve (+ small radial nerve branch)",root:"C5-C6",origin:"Anterior humerus (distal half)",insertion:"Coronoid process + ulnar tuberosity",
     patient:"Seated, elbow 90deg, forearm PRONATED (eliminates biceps supination advantage)",therapist:"Distal forearm",resistance:"Into extension",gravElim:"Supine, arm at side",palpation:"Lateral to biceps, distal arm - under biceps",
    ...
    {id:"mmt_tricep",muscle:"Triceps Brachii",action:"Elbow extension",nerve:"Radial nerve",root:"C6-C8 (primarily C7)",origin:"Infraglenoid tubercle (long) + posterior humerus (med/lat)",insertion:"Olecranon",
     patient:"Prone, arm over edge, elbow 90deg",therapist:"Distal forearm",resistance:"Into flexion",gravElim:"Supine, arm supported in 90deg shoulder flex",palpation:"Posterior arm - all three heads palpable; long head medial, lateral head lateral",
    ...
    {id:"mmt_pt",muscle:"Pronator Teres",action:"Forearm pronation + elbow flexion assist",nerve:"Median nerve",root:"C6-C7",origin:"Medial epicondyle + coronoid process",insertion:"Lateral radius (mid)",
     patient:"Seated, elbow 90deg, forearm supinated",therapist:"Distal forearm",resistance:"Into supination",gravElim:"Supported",palpation:"Medial forearm proximal - oblique cord from medial epicondyle",
  ...
  "Wrist & Hand":[
    ...
    {id:"mmt_lumb",muscle:"Lumbricals (1st-4th)",action:"MCP flexion + IP extension simultaneously",nerve:"Median (1st + 2nd) + Ulnar (3rd + 4th)",root:"C8-T1",origin:"FDP tendons",insertion:"Radial lateral band extensor hood",
     patient:"MCP 90deg flex, IPs extended",therapist:"Resist MCP into extension + IP into flexion",resistance:"Disrupt intrinsic-plus position",gravElim:"Hand supported",palpation:"Lateral aspect finger - very small; impractical to palpate",
  ...
  "Hip & Pelvis":[
    {id:"mmt_gmax",muscle:"Gluteus Maximus",action:"Hip extension + ER",nerve:"Inferior gluteal nerve",root:"L5-S2",origin:"Posterior ilium + sacrum + coccyx + sacrotuberous ligament",insertion:"Gluteal tuberosity + IT band",
     patient:"Prone, knee flexed 90deg (shortens hamstrings)",therapist:"Posterior distal thigh",resistance:"Into flexion (downward toward table)",gravElim:"Sidelying",palpation:"Buttock mass - most powerful hip extensor; palpate with knee flexed",
    ...
    {id:"mmt_tfl",muscle:"Tensor Fasciae Latae",action:"Hip flexion + abduction + IR; IT band tension",nerve:"Superior gluteal nerve",root:"L4-S1",origin:"ASIS + anterior iliac crest",insertion:"IT band -> Gerdy's tubercle",
     patient:"Supine, hip flexed 30deg + slight abd + IR",therapist:"Distal thigh",resistance:"Into extension + adduction + ER",gravElim:"Sidelying",palpation:"Lateral to ASIS - anterior lateral thigh proximal",
    ...
    {id:"mmt_hamstr",muscle:"Hamstrings (Biceps Femoris + Semitendinosus + Semimembranosus)",action:"Knee flexion + hip extension",nerve:"Sciatic nerve (tibial division for semi; common peroneal for BF short head)",root:"L5-S2",origin:"Ischial tuberosity (long) + linea aspera BF (short)",insertion:"Fibula head (BF) + medial tibia (semi)",
     patient:"Prone, knee 90deg",therapist:"Distal lower leg",resistance:"Into knee extension",gravElim:"Sidelying",palpation:"Posterior thigh - BF lateral, semiT + semiM medial; palpate at 90deg flex",
    ...
    {id:"mmt_pirif",muscle:"Piriformis",action:"Hip ER (neutral) + abduction (90deg flex)",nerve:"Nerve to piriformis (S1-S2)",root:"S1-S2",origin:"Anterior sacrum (S2-S4)",insertion:"Greater trochanter (superior)",
     patient:"Prone, knee 90deg, ER foot toward ceiling (hip ER test)",therapist:"Medial lower leg",resistance:"Into IR (push foot outward = IR = resist ER)",gravElim:"Supine",palpation:"Deep gluteal - midpoint between PSIS and greater trochanter; difficult",
    ...
    {id:"mmt_rectfem",muscle:"Rectus Femoris",action:"Knee extension + hip flexion",nerve:"Femoral nerve",root:"L2-L4",origin:"AIIS + acetabular ridge",insertion:"Quadriceps tendon -> patella -> patellar tendon -> tibial tuberosity",
     patient:"Supine, assess knee extension from 90deg",therapist:"Distal lower leg",resistance:"Into knee flex",gravElim:"Sidelying",palpation:"Anterior thigh central - straight line from AIIS to patella",
  ...
  "Knee":[
    {id:"mmt_quad",muscle:"Quadriceps (Vastus Medialis/Lateralis/Intermedius)",action:"Knee extension",nerve:"Femoral nerve",root:"L2-L4",origin:"Anterior femur",insertion:"Tibial tuberosity via patellar tendon",
     patient:"Seated, lower leg hanging",therapist:"Anterior distal lower leg",resistance:"Into knee flexion",gravElim:"Sidelying",palpation:"VMO: medial patella - last 10-15deg extension. VL: lateral thigh. VI: deep central",
    ...
    {id:"mmt_gastroc",muscle:"Gastrocnemius",action:"Ankle PF + knee flexion",nerve:"Tibial nerve",root:"S1-S2",origin:"Medial + lateral femoral condyles",insertion:"Calcaneus via Achilles tendon",
     ...
     functional:"Single-leg heel raise x 25 reps = normal. S1 myotome. Achilles rupture (Thompson test). DVT risk: calf pain",chain:"Weak gastroc + soleus -> reduced push-off -> gait compensation -> Achilles tendinopathy"},
    {id:"mmt_poplit",muscle:"Popliteus",action:"Knee IR (tibia on femur) + unlock knee from extension",nerve:"Tibial nerve",root:"L4-S1",origin:"Lateral femoral condyle + arcuate ligament",insertion:"Posterior proximal tibia",
     patient:"Prone, knee 90deg, tibial IR",therapist:"Distal lower leg medial border",resistance:"Into tibial ER",gravElim:"Sidelying",palpation:"Posterior knee - deep to heads of gastroc; palpate in popliteal fossa",
  ...
  "Ankle & Foot":[
    ...
    {id:"mmt_soleus",muscle:"Soleus",action:"Ankle plantarflexion (dominant with knee flexed)",nerve:"Tibial nerve",root:"S1-S2",origin:"Posterior fibula + soleal line tibia",insertion:"Calcaneus via Achilles tendon",
     patient:"Prone, KNEE FLEXED 90deg (slackens gastroc - isolates soleus)",therapist:"Plantar foot",resistance:"Into dorsiflexion",gravElim:"Sidelying",palpation:"Posterior calf deep to gastroc - bulges lateral to gastroc at ankle",
            ...
            <div key={m.id} ref={el=>{ if(el) mmtHlRef.current[m.id]=el; }} style={{background:C.surface,border:`1px solid ${hasVal?C.accent+"30":C.border}`,borderRadius:10,overflow:"hidden"}}>
              ...
              <div onClick={()=>setSelected(isOpen?null:m.id)} style={{padding:"10px 12px",cursor:"pointer",display:"flex",justifyContent:"space-between",alignItems:"center"}}>
                ...
                <div style={{display:"flex",gap:6,alignItems:"center"}}>
                  ...
                  <span style={{color:C.muted,fontSize:"0.7rem",marginLeft:4}}>{isOpen?"^":"v"}</span>
                </div>
              </div>
              ...
              {isOpen&&(
                <div style={{padding:"0 12px 12px 12px",borderTop:`1px solid ${C.border}`}}>
                  ...
                  <div style={{marginBottom:8}}>
                    ...
                    {[["Patient Position",m.patient,"👤"],["Therapist",m.therapist,"🙌"],["Resistance",m.resistance,"?"],["Gravity Eliminated",m.gravElim,"v"],["Palpation",m.palpation,"👆"]].map(([lbl,val,icon])=>(
      ...
      {(chainFindings.length>0||myotomeAnalysis.length>0)&&(
        <div style={{marginTop:14}}>
          <button type="button" onClick={()=>setShowInterp(p=>!p)} style={{width:"100%",padding:"9px",background:C.s2,border:`1px solid ${C.border}`,borderRadius:8,color:C.accent,fontWeight:700,fontSize:"0.78rem",cursor:"pointer"}}>
            {showInterp?"^ Hide":"v Show"} Clinical Interpretation
          </button>
          {showInterp&&(
...
const MYOTOMES = [
  ...
  { level:"C5",    action:"Shoulder abduction / deltoid", test:"Arm abduction 0-90deg resist",   compensation:"Trunk lean, shoulder hike" },
  ...
  { level:"L1-L2", action:"Hip flexion",                test:"Hip flex seated 0-90deg resist",    compensation:"QL, trunk lean back" },
  { level:"L3",    action:"Knee extension",             test:"Extend knee from 90deg against resist", compensation:"Hip flexor assist" },
  ...
  { level:"S2",    action:"Knee flexion (hamstring)",   test:"Prone knee flex 90deg resist",      compensation:"Gastrocnemius, gluteus max" },
];
...
const REFLEXES = [
  ...
  { id:"n_ref_bicep",   label:"Biceps",                  level:"C5-C6",           group:"DTR", technique:"Elbow flexed to ~90deg. Place thumb firmly on biceps tendon in antecubital fossa. Tap thumb with reflex hammer. Observe/feel for elbow flexion.", finding:"Diminished or absent = C5/C6 LMN (radiculopathy, peripheral nerve). Brisk/hyperactive = UMN (myelopathy, cord compression above C5). Asymmetry always significant.", pathological:false, umnSign:false },
  ...
  { id:"n_ref_tricep",  label:"Triceps",                 level:"C6-C7",           group:"DTR", technique:"Support arm at 90deg abduction or drape over forearm. Tap triceps tendon directly above olecranon. Observe elbow extension.", finding:"Diminished or absent = C7 radiculopathy (most common cause). Absent bilaterally = peripheral polyneuropathy or motor neuron disease. Brisk = UMN above C7.", pathological:false, umnSign:false },
  { id:"n_ref_patella", label:"Patella (Quadriceps)",    level:"L3-L4",           group:"DTR", technique:"Patient seated with legs hanging freely (or supine with knee supported at 20-30deg). Tap patellar tendon briskly. Observe quadriceps contraction / knee extension.", finding:"Diminished = L3/4 disc herniation (most common). Absent = severe radiculopathy or femoral neuropathy. Brisk + Babinski = cord/UMN.", pathological:false, umnSign:false },
...
const NEURAL_TENSION = [
  {
    ...
    positive:"Radicular pain/paraesthesia in distribution below knee between 30-70deg. Above 70deg = hamstring tightness.",
  ...
  },
  {
    ...
    procedure:"Shoulder depress -> abduct 90deg -> ER -> extend elbow -> supinate forearm -> extend wrist/fingers. Add cervical lateral flex (contralateral).",
  ...
  },
  {
    ...
    procedure:"Shoulder depress + ER -> abduct 90deg -> IR -> extend elbow -> pronate forearm -> flex wrist.",
  ...
  },
  {
    ...
    procedure:"Patient prone. Flex knee to 90deg. Therapist extends hip. Add cervical extension to sensitise. Positive = anterior thigh pain / L2-L4 distribution.",
  ...
  return (
    <div style={{marginBottom:14}}>
      ...
      >
        ...
        <span style={{fontSize:"0.85rem", color:C.accent, fontWeight:700}}>{open ? "^" : "v"}</span>
      </button>
      {open && (
        <div style={{
        ...
        <div>
            ...
            <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10,marginBottom:12}}>
              ...
              <div style={{background:C.s3,borderRadius:8,padding:"10px 12px"}}>
                ...
                <div style={{fontSize:"0.68rem",color:C.muted,lineHeight:1.8}}>
                  ...
                  <div style={{marginTop:3,fontSize:"0.65rem",color:C.muted}}>28 key points x 2 sides x 2 modalities = 112 per modality</div>
                </div>
              </div>
            </div>
          ...
          <div style={{marginBottom:14}}>
            ...
            {[
              ...
              {level:"C7",label:"Elbow Extensors",muscle:"Triceps",test:"Resist elbow extension from 90deg flexion"},
              ...
              {level:"L2",label:"Hip Flexors",muscle:"Iliopsoas",test:"Resist hip flexion from 90deg (seated)"},
              {level:"L3",label:"Knee Extensors",muscle:"Quadriceps",test:"Resist knee extension from 90deg (seated)"},
              ...
              {level:"S1",label:"Ankle Plantarflexors",muscle:"Gastrocnemius/Soleus",test:"Standing single heel raise x 10 or resist plantarflexion"},
            ].map(m=>{
