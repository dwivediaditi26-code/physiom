                ...
                <div style={{ padding:"14px 16px", display:"flex", flexDirection:"column", gap:12 }}>
                  ...
                  <div style={{ background: PC.s2, borderRadius:10, padding:"12px 14px",
                    ...
                    {r.differentials.length === 0 && (
                      <div style={{ fontSize:"0.74rem", color: PC.muted }}>Insufficient data — complete subjective form</div>
                    )}
                    {r.differentials.map((d, di) => (
                      <div key={di} style={{
                        background: di===0 ? regCol+"12" : PC.surface,
                        border:`1px solid ${di===0 ? regCol+"44" : PC.border}`,
                        borderRadius:8, padding:"9px 12px", marginBottom:6,
                      }}>
                        <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:3 }}>
                    ...
                    {/* Clinical pattern bar */}
                    <div style={{ display:"flex", gap:6, flexWrap:"wrap", marginTop:8 }}>
                      {[
                        {label:"Mechanical",on:r.mechanicalPattern,col:PC.green},
                        {label:"Inflammatory",on:r.inflammatoryPattern,col:"#f59e0b"},
                  ...
                  <div style={{ borderRadius:10, border:`1px solid ${PC.border}`, overflow:"hidden" }}>
                    <div style={{ background: PC.s3, padding:"8px 13px", display:"flex", alignItems:"center", gap:8 }}>
                      ...
                      <span style={{ flex:1 }}/>
                      {onNav && postureRegion && <button onClick={()=>onNav("posture",{ region:postureRegion })} style={{ fontSize:"0.78rem", fontWeight:800, padding:"3px 10px", background:PC.a3+"18", border:`1px solid ${PC.a3}44`, borderRadius:20, color:PC.a3, cursor:"pointer" }}>Posture →</button>}
                      {onNav && obsCode && <button onClick={()=>onNav("observation",{ obsRegion:obsCode })} style={{ fontSize:"0.78rem", fontWeight:800, padding:"3px 10px", background:PC.accent+"22", border:`1px solid ${PC.accent}44`, borderRadius:20, color:PC.accent, cursor:"pointer" }}>Start Observation →</button>}
                    </div>
                  ...
                  <div style={{ borderRadius:10, border:`1px solid ${PC.border}`, overflow:"hidden" }}>
                    ...
                    <div style={{ padding:"10px 13px", display:"flex", flexDirection:"column", gap:8 }}>
                      ...
                      {testsByDx.map((td, tdi)=>(
                        <div key={tdi} style={{
                          background: tdi===0 ? PC.green+"08" : PC.s2,
