...
import { TextField, SelectField, Segmented, TextArea, YesNo, SectionIntro, StepNav, useSectionData, fmtVal, MissingDemographicsModal, missingDemographicsFields } from "./orthoFieldKit.jsx";
...
export default function OrthoIPDAssessment({ selectedRegions, condition, customConditionLabel, onExit, onSave, activePatientId, patientData, initialData, initialStep }) {
  ...
  // received onSave/activePatientId at all, so a full IPD assessment vanished
  // the moment you left the screen -- nothing to "Copy assessment as text"
  // into was ever saved to the patient record itself.
  function saveAssessment() {
    if (!onSave) return;
    onSave("ortho_ipd_assessment", JSON.stringify({
